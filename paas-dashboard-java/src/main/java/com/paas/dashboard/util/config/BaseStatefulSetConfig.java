...
public class BaseStatefulSetConfig extends BaseConfig {
    ...
    public BaseStatefulSetConfig() {
    }

    public BaseStatefulSetConfig(String name, String k8sName, String namespace, String statefulSetName) {
        super(name);
