...
public class Settings {
    ...
    public Settings(String sshExecuteTimeoutSeconds, String sshJumpTimeoutSeconds, String sshLoginTimeoutSeconds,
                    String jdk8X86FilePath, String jdk11X86FilePath, String jdk17X86FilePath, String jdk8ArmFilePath,
                    String jdk11ArmFilePath, String jdk17ArmFilePath, String dumpFileDir, String tcpdumpArmFilePath,
                    String tcpdumpX86FilePath) {
