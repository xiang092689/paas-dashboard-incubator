...
class _RedisPageState extends State<RedisPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var exportButton = FormUtil.createExportButton(RedisInstanceDto.fieldList(),
        vm.instances.map((e) => e.redisInstancePo.toMap().values.toList()).toList(), context);
    var importButton = FormUtil.createImportButton(RedisInstanceDto.fieldList(), context,
