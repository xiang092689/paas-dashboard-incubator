...
class PulsarInstanceCreateReq {
  ...
  PulsarInstanceCreateReq(this.name, this.host, this.port, this.functionHost, this.functionPort, this.enableTls,
      this.functionEnableTls, this.caFile, this.clientCertFile, this.clientKeyFile, this.clientKeyPassword);

  PulsarInstanceCreateReq deepCopy() {
    return PulsarInstanceCreateReq(name, host, port, functionHost, functionPort, enableTls, functionEnableTls, caFile,
  ...
  @override
  String toString() {
    return 'PulsarInstance{name: $name, host: $host, port: $port, functionHost: $functionHost, functionPort: $functionPort, enableTls: $enableTls, functionEnableTls: $functionEnableTls, caFile: $caFile, clientCertFile: $clientCertFile, clientKeyFile: $clientKeyFile, clientKeyPassword: $clientKeyPassword}';
  }
}
